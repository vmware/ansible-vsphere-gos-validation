...
- For SLES 16.1 unattend auto-install, please use file SLE/16.1/SLES/autoinst.jsonnet (set parameter 'sles_operating_mode: immutable' for Immutable Mode).
...
- For Kylin Linux Advanced Server V10 or later unattend auto-install, please use file Kylin/Server/10/ks.cfg.
