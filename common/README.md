...
* esxi_get_guest_config_options_api.yml: Get VM config options for a guest id on a hardware version from API
* esxi_get_guest_config_options_xml.yml: Get VM config options for a guest id on a hardware version from VM config option file in XML
